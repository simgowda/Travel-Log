...
function cheaperTrip(trip1, trip2){
    let trip1Cost = tripObject1.tripLen * tripObject1.costPerDay / tripObject1.numTravellers;
    let trip2Cost = tripObject2.tripLen * tripObject2.costPerDay / tripObject2.numTravellers;
...
/*async function fetchExchangeRate(currency1, currency2){
    int result = await getExchangeRate[currency1, currency2];
